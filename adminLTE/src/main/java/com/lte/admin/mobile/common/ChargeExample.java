...
public class ChargeExample {
     ...
     */
    private final static String apiKey = "sk_test_Kif5e9iDKibHm5S8G4iLSSCS";
    /**
     * Pingpp 管理平台对应的应用 ID，app_id 获取方式：登录 [Dashboard](https://dashboard.pingxx.com)->点击你创建的应用->应用首页->应用 ID(App ID)
     */
    private static String appId = "app_WvbTiDP40GSCC4Gi";
...
//        chargeExample.retrieve(charge.getId());
     ...
     * @param money
     */
    public static Charge payByPing(String channel, Double money, String orderNo){
        ...
        try{
            // Charge 示例
            ChargeExample chargeExample = new ChargeExample();
            charge = chargeExample.createCharge(channel,money,orderNo);
        }catch (Exception e){
            e.printStackTrace();
        }
        return  charge;
     ...
     * @return Charge
     */
    public Charge createCharge(String channel,Double money,String orderNo) {
        Charge charge = null;
        Map<String, Object> chargeMap = new HashMap<String, Object>();
        chargeMap.put("amount", money*100);//订单总金额, 人民币单位：分（如订单总金额为 1 元，此处请填 100）
        chargeMap.put("currency", "cny");
        chargeMap.put("subject", "舜昊租车");
        chargeMap.put("body", "支付费用");
