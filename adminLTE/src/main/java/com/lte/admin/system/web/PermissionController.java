...
import com.lte.admin.system.service.PermissionService;
...
public class PermissionController extends BaseController {
	...
	public List<Permission> myPermissionDate() {
		...
		// List<Permission>
		// permissionList=permissionService.getPermissions(UserUtil.getCurrentUser().getPkPsnbasdoc());
		List<Permission> permissionList = permissionService.getPermissionsmenu(
				UserUtil.getCurrentUser().getMemberCode(), UserUtil.getCurrentUser().getDeptCode());
		return permissionList;
	}
	...
	@ResponseBody
	public List<Permission> otherPermissionDate(@PathVariable("userId") String userId) {
	 ...
	 */
	// @RequiresPermissions("sys:perm:add")
	// @RequestMapping(value = "createBase/{pname}/{pid}", method =
	// RequestMethod.GET)
	// @ResponseBody
	// public String create(@PathVariable("pname") String
	// pname,@PathVariable("pid") Integer pid){
