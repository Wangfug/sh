 ...
 */
package com.lte.admin.common.ping.prod;

import com.lte.admin.common.ping.example.Main;
...
public class ChargeService {
    ...
    ChargeService(String appId) {
        this.appId = appId;
    }

    public static void runDemos(String appId) {

        ChargeService chargeService = new ChargeService(appId);
        System.out.println("------- 创建 charge -------");
        Map<String,Object> paramMap = new HashMap<String,Object>();
        Charge charge = chargeService.createCharge(paramMap);
        System.out.println("------- 查询 charge -------");
        chargeService.retrieve(charge.getId());
     ...
     * @return Charge
     */
    public Charge createCharge(Map<String, Object> chargeMap) {
        Charge charge = null;
