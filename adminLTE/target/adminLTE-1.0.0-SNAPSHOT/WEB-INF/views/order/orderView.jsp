...
<div id="tb" style="padding:5px;height:auto">
  <div>
    <form id="searchFrom" action="">
      <input type="text" name="filter_title" class="easyui-validatebox" data-options="width:150,prompt: '订单号'"/>
...
<script type="text/javascript">
    ...
    $(function(){
        dg=$('#dg').datagrid({
            method: "POST",
            url:'${ctx}/order/orderInfo/getOrderList',
            fit : true,
            fitColumns : true,
            border : false,
            striped:true,
            ...
            columns:[[
                ...
                {field:'orderNo',title:'订单号',sortable:true,width:100,formatter : function(value, row, index) {
                    console.log(value)
                    return '<a href="javascript:;" onclick="viewtz('+row.id+',\''+row.createBy+'\');">'+row.orderNo+'</a>';
                }},
                {field:'carId',title:'订单车辆',sortable:true,width:100},
