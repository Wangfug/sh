...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
       	        <input type="text" name="filter_code" class="easyui-validatebox" data-options="width:150,prompt: '代码'"/>
       	        <input type="text" name="filter_name" class="easyui-validatebox" data-options="width:150,prompt: '名称'"/>
...
$(function(){   
    ...
    columns:[[    
        ...
        {field:'comment',title:'说明',sortable:true,width:100},    
        {field:'parentName',title:'父节点',sortable:true},
...
function add() {
	d=$("#dlg").dialog({   
	    ...
	    width: 380,    
	    height: 250,    
	    href:'${ctx}/system/dictType/create',
	    maximizable:true,
	    modal:true,
	    buttons:[{
			text:'确认',
...
function del(){
	...
	parent.$.messager.confirm('提示', '注销后无法恢复，您确定要注销？', function(data){
		if (data){
			$.ajax({
				type:'get',
				url:"${ctx}/system/dictType/delete/"+row.id,
...
function upd(){
	...
	d=$("#dlg").dialog({   
	    ...
	    width: 380,    
	    height: 250,    
	    href:'${ctx}/system/dictType/update/'+row.id,
	    maximizable:true,
	    modal:true,
	    buttons:[{
			text:'修改',
